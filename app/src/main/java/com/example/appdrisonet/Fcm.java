...
public class Fcm extends FirebaseMessagingService {
    ...
    private void menorqueoreo(String titulo,String detalle) {
        ...
        builder.setAutoCancel(true).setWhen(System.currentTimeMillis()).setContentTitle(titulo).setSmallIcon(R.mipmap.ic_logop).setContentText(detalle).setContentInfo("nuevo ").setContentIntent(clikcnoti());
